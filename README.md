...
[setting.owner]
defaultValue = "PUT YOUR EOA ADDRESS HERE"
...
If it is your first time using cannon you might want to run
...
**Now fund your contract with some LINK tokens in order to pay for the vrf feature.**
...
Be aware that chainlinks vrf only works properly on Goerli testnet. If you are interacting with it locally without mocking it, it will fail.
